...
export class PointerCorrector {
    ...
    map(position) {
        ...
        _position[0] =
            (_position[0] / this._contentRect.width) * this._videoWidth;
        _position[1] =
    ...
    get contentRect() {
        ...
        const y =
            letterBoxType === LetterBoxType.Horizontal ? letterBoxSize : 0;
        const width =
            letterBoxType === LetterBoxType.Vertical
                ? this._rect.width - letterBoxSize * 2
                : this._rect.width;
        const height =
            letterBoxType === LetterBoxType.Horizontal
                ? this._rect.height - letterBoxSize * 2
                : this._rect.height;
